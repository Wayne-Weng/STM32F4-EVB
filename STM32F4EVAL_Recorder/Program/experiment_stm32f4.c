...
void SDCARD_Recorder( void )
{
  ...
  LCD_Clear(BLACK);
	...
	// Open File
  LCD_PutStr(Axis_X, Axis_Y+16*0, (u8*)"-----------------------", ASCII1608, WHITE, BLACK);
  LCD_PutStr(Axis_X, Axis_Y+16*1, (u8*)" SD_Card Open",           ASCII1608, WHITE, BLACK);
  LCD_PutStr(Axis_X, Axis_Y+16*2, (u8*)"-----------------------", ASCII1608, WHITE, BLACK);
  ...
  if(res==FR_OK) {
    ...
    LCD_PutStr(Axis_X+8*12, Axis_Y+16*3, (u8*)"No File!!", ASCII1608, WHITE, BLACK);
    f_open(&file, "BlackBox.dat", FA_CREATE_NEW | FA_READ | FA_WRITE);
    LCD_PutStr(Axis_X,      Axis_Y+16*4, (u8*)" Create New File!!", ASCII1608, WHITE, BLACK);
    LCD_PutStr(Axis_X,      Axis_Y+16*5, (u8*)" f_write ... ", ASCII1608, WHITE, BLACK);
    res = f_write(&file, SD_Buf_Info, 16, &i);
    if(res==FR_OK)
      LCD_PutStr(Axis_X+8*13, Axis_Y+16*5, (u8*)"OK!!", ASCII1608, WHITE, BLACK);
    else
      LCD_PutStr(Axis_X+8*13, Axis_Y+16*5, (u8*)"failed!!", ASCII1608, WHITE, BLACK);
  }
  else {
    LCD_PutStr(Axis_X+8*12, Axis_Y+16*3, (u8*)"failed!!", ASCII1608, WHITE, BLACK);
  }
  ...
  LCD_PutStr(Axis_X, Axis_Y+16*0, (u8*)"-----------------------", ASCII1608, WHITE, BLACK);
  LCD_PutStr(Axis_X, Axis_Y+16*1, (u8*)" SD_Card Recorder",       ASCII1608, WHITE, BLACK);
  LCD_PutStr(Axis_X, Axis_Y+16*2, (u8*)"-----------------------", ASCII1608, WHITE, BLACK);

  LCD_PutStr(Axis_X, Axis_Y+16*3, (u8*)" File Size : ", ASCII1608, WHITE, BLACK);
  LCD_PutStr(Axis_X, Axis_Y+16*5, (u8*)" AngE_X : "   , ASCII1608, WHITE, BLACK);
  LCD_PutStr(Axis_X, Axis_Y+16*6, (u8*)" AngE_Y : "   , ASCII1608, WHITE, BLACK);

  while(1) {
    LCD_PutNum(Axis_X+8*10, Axis_Y+16*5,  Type_I, 5, WaveFormData[0], WHITE, BLACK);
    LCD_PutNum(Axis_X+8*10, Axis_Y+16*6,  Type_I, 5, WaveFormData[1], WHITE, BLACK);
    if(SD_Flag==1) {
      ...
      LCD_PutNum(Axis_X+8*13, Axis_Y+16*3,  Type_D, 5, file.fsize, WHITE, BLACK);
